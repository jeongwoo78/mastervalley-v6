...
export const masterChat = {
  ...
  // ===== 추천 질문 (7명 × 3개 = 21개) =====
  suggestedQuestions: {
    'VAN GOGH': ['머리색 바꿔주세요', '동그란 안경 씌워주세요', '귀 얘기 해주세요', '왜 해바라기 좋아해?'],
    'KLIMT': ['입술 색 바꿔주세요', '금빛 귀걸이 달아주세요', '키스 그림 모델이 누구예요?', '왜 금색을 좋아해요?'],
    'MUNCH': ['머리색 바꿔주세요', '동그란 안경 씌워주세요', '결혼했어요?', '절규는 왜 그렸어요?'],
    'CHAGALL': ['머리색 바꿔주세요', '귀걸이 달아주세요', '사랑해 봤어요?', '동물들을 좋아해요?'],
    'MATISSE': ['입술 색 바꿔주세요', '안경 씌워주세요', '본인 소개해 주세요', '왜 색이 이렇게 밝아요?'],
    'FRIDA': ['입술 색 바꿔주세요', '꽃 귀걸이 달아주세요', '사고 얘기 해주세요', '왜 자화상을 많이 그렸어요?'],
    'LICHTENSTEIN': ['머리색 바꿔주세요', '팝아트 안경 씌워주세요', '본인 소개해 주세요', '왜 만화처럼 그려요?']
  },
