...
export const masterChat = {
  ...
  suggestedQuestions: {
    'VAN GOGH': ['Change my hair color', 'Tell me about your ear', 'Why do you love sunflowers?'],
    'KLIMT': ['Change my lip color', 'Who was the model for The Kiss?', 'Why do you love gold?'],
    'MUNCH': ['Change my hair color', 'Were you married?', 'Why did you paint The Scream?'],
    'CHAGALL': ['Change my hair color', 'Have you been in love?', 'Do you like animals?'],
    'MATISSE': ['Change my lip color', 'Tell me about yourself', 'Why are your colors so bright?'],
    'FRIDA': ['Change my lip color', 'Tell me about your accident', 'Why so many self-portraits?'],
    'LICHTENSTEIN': ['Change my hair color', 'Tell me about yourself', 'Why do you paint like comics?']
  },
