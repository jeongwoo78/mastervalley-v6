...
export const ORIENTAL_PROMPTS = {
  ...
  'ukiyoe': {
    ...
    prompt: `Japanese Ukiyo-e woodblock print in bijin-ga (美人画) beautiful woman style by Kitagawa Utamaro. STUNNINGLY BEAUTIFUL refined face with captivating almond eyes, graceful arched eyebrows, small delicate lips, porcelain complexion with subtle blush. FLAT SOLID COLOR AREAS with BOLD BLACK OUTLINES 3mm thick. Elegant elongated neck and graceful hand gestures. LIMITED PALETTE of water-soluble pigments - indigo (藍), vermillion (朱), yellow ochre, green, pink. CHERRY WOOD BLOCK TEXTURE (桜板) visible in color areas with subtle wood grain. BAREN-PRESSED TEXTURE with varying pressure creating gradation effects (bokashi). Completely FLAT TWO-DIMENSIONAL aesthetic. Dramatic asymmetrical compositions. Transform clothing to LUXURIOUS traditional KIMONO with intricate decorative patterns. Elegant Edo period aesthetic, idealized flattering portrait.`
  },

  'ukiyoe_yakushae': {
    name: '우키요에 역자회',
    nameEn: 'Japanese Ukiyo-e Yakusha-e',
    prompt: `Japanese Ukiyo-e woodblock print in yakusha-e (役者絵) kabuki actor portrait style by Toshusai Sharaku. STRIKINGLY HANDSOME masculine face with piercing intense eyes, strong angular jawline, powerful dignified expression. BOLD DRAMATIC EXPRESSION with exaggerated theatrical features capturing charismatic intensity. DARK MICA BACKGROUND (雲母摺) creating silvery metallic sheen behind figure. STRONG ANGULAR BLACK OUTLINES 4mm thick defining powerful masculine features. LIMITED PALETTE of water-soluble pigments - deep indigo (藍), vermillion (朱), yellow ochre, black, grey. CHERRY WOOD BLOCK TEXTURE (桜板) visible in color areas. Sharp geometric forms and dramatic asymmetry. Transform clothing to traditional HAKAMA (袴) with HAORI jacket and bold patterns. Powerful commanding Edo period masculine aesthetic, idealized dignified portrait.`
  },
