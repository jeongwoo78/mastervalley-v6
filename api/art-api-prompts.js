...
export const ANCIENT_MEDIEVAL_PROMPTS = {
  ...
  'byzantine-deesis': {
    name: '데이시스',
    nameEn: 'Deesis',
    prompt: `Byzantine sacred wall mosaic of the subject. Tiny glass and gold leaf tesserae cover every surface including face, skin, hair, and clothing. Shimmering gold leaf background wall. Large wide eyes gaze directly forward. A circular golden halo radiates behind the head. Rich jewel-tone glass tiles for robes. Clothing transformed into Byzantine imperial robes with gold and jewels. Deep gold and blue tiles radiate outward from the center. Gold 45%, deep blue 25%, burgundy 20%, ivory 10%. A shimmering gold leaf wall wraps the entire background. Skin is rendered in ivory and pale olive tiles. Gold tiles blaze intensely at the halo edges. Tiles are arranged radially outward from the halo center. Bright light descends from above. Deep blue tiles create shadow in the robe folds. The gold ground holds alternating deep blue and burgundy accents.`
  },
  ...
  'gothic-saintechapelle': {
    ...
    prompt: `Gothic cathedral stained glass window of the subject. Colored glass pieces joined by thick black lead came lines forming every surface including face, skin, hair, and clothing. Light transmits through translucent glass creating jewel-like luminous glow. Uneven glass thickness with tiny bubbles visible. Flat angular forms with heavy black outlines. Clothing transformed into medieval long robes. Intense ruby red glass panels tower vertically with light pouring through. Ruby red 45%, deep blue 25%, gold 20%, ivory 10%. Towering vertical panels fill the entire background. Vertical columns and pointed arches decorate the space. Skin is rendered in ivory and pale pink glass. Gold glass gleams on column ornaments and arch tops. Glass pieces are arranged in tall vertical strips reaching skyward. Light pours down from above like a waterfall. Deep ruby glass casts a red shadow across the entire robe. The ruby ground holds blue and gold placed in vertical stripes.`
  },
...
export const IMPRESSIONISM_PROMPTS = {
  ...
  'renoir-moulin': {
    ...
    prompt: `Hand-painted oil painting of the subject by Pierre-Auguste Renoir. Soft feathery brushstrokes build warm luminous layers of color. Rosy pink and golden tones glow with sensuous warmth. Outlines dissolve into shimmering dappled light. The surface shimmers with a pearly iridescent quality. Edges between forms melt into surrounding warm light. Warm golden sunlight dapples through trees onto a lively gathering. Gold 30%, cobalt blue 25%, rosy pink 25%, olive green 20%. Trees and a sunlit outdoor gathering space fill the background. Skin glows in soft rosy pink and warm golden ivory. Bright spots of sunlight scatter across the figures. Brushwork follows the movement of light spreading through the scene. Warm dappled sunlight filters down through the tree canopy. Cobalt blue and olive green settle into the tree shadows. Gold and pink concentrate on the sunlit figures with green reserved for the shaded edges.`
  },
  ...
  'renoir-swing': {
    name: '그네',
    nameEn: 'The Swing',
    prompt: `Hand-painted oil painting of the subject by Pierre-Auguste Renoir. Soft feathery brushstrokes build warm luminous layers of color. Rosy pink and golden tones glow with sensuous warmth. Outlines dissolve into shimmering dappled light. The surface shimmers with a pearly iridescent quality. Edges between forms melt into surrounding warm light. Soft dappled sunlight scatters through leaves onto a garden scene. Cobalt blue 30%, rosy pink 25%, olive green 25%, ivory 20%. Tall garden trees and soft green foliage fill the background. Skin glows in soft ivory and warm rosy peach. Bright spots of filtered sunlight scatter across the figures and ground. Brushwork scatters in loose strokes and coloured dots following the dappled light through the leaves. Warm dappled light filters through the leaves from above. Olive green and cobalt blue settle into tree shadows and foliage. Rosy pink and ivory concentrate on the central figure with green reserved for the surrounding garden.`
  },
...
export const POST_IMPRESSIONISM_PROMPTS = {
  ...
  'gauguin-where': {
    ...
    prompt: `Hand-painted oil painting of the subject by Paul Gauguin. Flat unmixed color areas spread broadly across the surface. Intense primary colors are placed side by side decoratively. Outlines are enclosed by thick dark contour lines. The surface is smooth and flat with minimal visible brushwork. Edges between forms are sharply defined by bold outlines. Deep blue and gold fill the surface heavily and deeply. Deep blue 35%, gold yellow 25%, olive green 25%, ivory 15%. Deep blue and green landscape fills the background. Skin is filled flatly with warm gold and ochre color planes. Gold light rests flatly on the figures. Brushwork flows in a long horizontal direction. Soft light wraps the entire scene evenly. Deep blue and olive green sink heavily into the background and lower areas. Gold and ochre placed on the figures with deep blue and green reserved for the background.`
  },
...
export const FAUVISM_PROMPTS = {
  ...
  'matisse-purplecoat': {
    ...
    prompt: `Hand-painted oil painting of the subject by Henri Matisse. Pure primary colors spread flatly in broad areas. Face and skin are painted freely in non-naturalistic colors like green, purple, and red. Forms are simplified into rhythmic flowing curves. Outlines flow in supple decorative curves. The surface is flat and decorative with smooth visible brushmarks. Edges between forms are defined by bold color boundaries. Deep purple dominates the scene with quiet elegance. Deep purple 35%, emerald green 25%, orange 20%, ivory 20%. Warm base with leaf patterns fills the background decoratively. Leaf patterns on background, ornamental coat patterns. The face is painted softly in warm peach and apricot tones, eyes accented with bold dark outlines. Orange light rests flatly on the face and bright areas. Brushwork flows along the elegant vertical curves of the coat. Soft light illuminates the entire scene evenly. Deep purple sinks into the coat folds and dark areas. Purple claims the figure with green and orange reserved for the background.`
  },
  ...
  'matisse-derain': {
    ...
    prompt: `Hand-painted oil painting of the subject by Henri Matisse. Pure primary colors spread flatly in broad areas. Face and skin are painted freely in non-naturalistic colors like green, purple, and red. Forms are simplified into rhythmic flowing curves. Outlines flow in supple decorative curves. The surface is flat and decorative with smooth visible brushmarks. Edges between forms are defined by bold color boundaries. Pure primary colors spread intensely across the face. Chrome yellow 30%, emerald green 25%, cobalt blue 25%, vermilion red 20%. Bright primary color planes fill the background simply. Yellow and green are placed boldly on the forehead and cheeks, red and blue painted roughly on the nose and jaw. Chrome yellow light rests in pure color on the forehead and bright surfaces. Brushwork follows the face contours smoothly in broad color areas. Strong light illuminates the face directly from the front. Green and blue sink around the eyes and below the jaw. Yellow and red claim the bright planes with green and blue reserved for the shadows.`
  },
  ...
  'matisse-redroom': {
    name: '붉은 방',
    nameEn: 'The Red Room',
    prompt: `Hand-painted oil painting of the subject by Henri Matisse. Pure primary colors spread flatly in broad areas. Face and skin are painted freely in non-naturalistic colors like green, purple, and red. Forms are simplified into rhythmic flowing curves. Outlines flow in supple decorative curves. The surface is flat and decorative with smooth visible brushmarks. Edges between forms are defined by bold color boundaries. Intense red overwhelms the walls and table surface. Vermilion red 40%, cobalt blue 25%, emerald green 20%, ivory 15%. Red-covered walls with blue arabesque patterns fill the background. Blue arabesque floral curve patterns as decoration. The face is painted flatly in warm orange and pink color planes. Ivory light rests flatly on bright surfaces. Brushwork flows along the decorative arabesque curve patterns. Green light enters from the window on the left. Deep red sinks into the table and deep wall surfaces. Red claims the entire interior with blue claiming the decorative patterns and green claiming the garden outside.`
  },
...
export const EXPRESSIONISM_PROMPTS = {
  ...
  'munch-scream': {
    name: '절규',
    nameEn: 'The Scream',
    prompt: `Hand-painted oil painting of the subject by Edvard Munch. Wavy distorted lines swirl across the entire surface, trembling with rough unstable brushmarks. Outlines ripple and twist as edges dissolve into wavy flowing lines. Blood orange ripples across the entire surface. Blood orange 35%, cobalt blue 25%, sickly yellow 20%, ivory 20%. Undulating blood-red sky and dark landscape fill the background. Face and skin stretch and distort in undulating waves, eyes sink deep, cheeks cave inward, painted in pale ivory and sickly yellow. Sickly yellow light rests on the face and bright areas of the sky. Brushwork follows undulating wave lines crossing the entire sky and landscape. Sunset light blazes in blood red from behind. Cobalt blue sinks heavily into the water and lower landscape. Orange and yellow claim the sky with blue claiming the water and lower areas.`
  },
  ...
  'munch-madonna': {
    name: '마돈나',
    nameEn: 'Madonna',
    prompt: `Hand-painted oil painting of the subject by Edvard Munch. Wavy distorted lines swirl across the entire surface, trembling with rough unstable brushmarks. Outlines ripple and twist as edges dissolve into wavy flowing lines. A dark red aura wraps around the figure. Crimson red 30%, deep black 30%, ivory 25%, gold 15%. Deep black fills the background. Face and skin stretch and distort in undulating waves, the face elongates into a pale glowing oval of ivory with a reddish flush. Red aura light radiates outward around the hair. Brushwork spreads outward following the undulating flow of the hair. Soft red light radiates from inside the figure outward. Deep black sinks into the background and deep within the hair. Ivory claims the skin with crimson claiming the aura and black claiming the background.`
  },
  ...
  'munch-danceoflife': {
    ...
    prompt: `Hand-painted oil painting of the subject by Edvard Munch. Wavy distorted lines swirl across the entire surface, trembling with rough unstable brushmarks. Outlines ripple and twist as edges dissolve into wavy flowing lines. Colors spread under moonlight in a cool haze. Crimson red 30%, deep blue 25%, ivory 25%, olive green 20%. Moonlit beach and undulating sea fill the background. Face and skin stretch and distort in undulating waves, features dissolve into dots and short lines, forehead and cheeks pushed flat in a single tone of ivory and sickly pink. Moonlit ivory light reflects long on the figures and water. Brushwork flows along the undulating curves of the figures. Moonlight illuminates coldly from above. Deep blue and olive green sink heavily into the background and beneath the figures. Crimson red claims the central areas with ivory and black claiming the sides and blue claiming the background.`
  },
...
export const MODERNISM_PROMPTS = {
  ...
  'magritte-golconda': {
    name: '골콩다',
    nameEn: 'Golconda',
    prompt: `Hand-painted oil painting of the subject by René Magritte. Smooth realistic brushwork renders every surface with photographic precision. Ordinary objects placed in impossible arrangements. Colors are muted and naturalistic with clear even lighting. Edges are clean and precise, surface entirely smooth throughout. Dark grey 30%, pale blue 30%, beige 20%, crimson red 20%. Pale blue sky and red-roofed buildings fill the background. CRITICAL: The subject appears as ONE large figure in the foreground AND is repeated as 30+ IDENTICAL smaller figures filling the ENTIRE SKY in an evenly spaced grid pattern, floating weightlessly at different distances, growing progressively smaller toward the horizon. Foreground floating figures are SHARP and DETAILED with visible facial features, middle figures slightly softer, background figures become small and hazy. The sky must be DENSELY FILLED with these floating figures. ENTIRE IMAGE must look like a HAND-PAINTED OIL PAINTING with visible smooth brushstrokes on canvas. The main foreground subject must show clear OIL PAINT TEXTURE - smooth but painterly, every surface showing hand-painted quality. Skin rendered with layered oil paint strokes, clothing with thick opaque paint. Face painted with Magritte's characteristic smooth matte oil finish, expression still and neutral. Soft light from the left brightens one side of the face. Smooth brushwork flows precisely along building lines and sky. Blue fills the sky, red fills rooftops, beige fills buildings.`
  },
  ...
  'miro-constellation': {
    ...
    prompt: `Hand-painted oil painting of the subject by Joan Miró. Black lines and primary color forms float freely on open canvas. Figures reduced to simple symbols like dots, lines, circles, triangles. Primary colors and black arranged across wide empty space. Outlines drawn in bold black lines. Stars and symbols fill densely like a night sky. Cream beige 30%, black 25%, vermilion red 20%, cobalt blue 15%, chrome yellow 10%. Soft translucent wash stains fill the background irregularly. Stars, eyes, crescents, hourglass forms painted in red, blue, yellow, black densely covering the surface. Primary color forms glow like jewels on soft beige background. Thin black lines connect stars and symbols like a web flowing throughout. Even light illuminates the entire surface flatly. Black sinks into lines and inside forms. Beige wash claims the background, red blue yellow fill the symbols, black remains in lines and outlines.`
  },
...
export const ORIENTAL_PROMPTS = {
  ...
  'minhwa': {
    ...
    prompt: `Korean folk painting (Minhwa) style from late Joseon Dynasty. MINERAL PIGMENTS on AGED YELLOWED HANJI PAPER with visible fiber texture. BOLD VIBRANT Obangsaek colors (red, blue, yellow, white, black) applied in LAYERS from light to dark. Various brush sizes creating different textures and lines. SIMPLIFIED EXAGGERATED FORMS with humor and naive charm. SYMBOLIC MOTIFS: tigers and magpies (호작도), peonies (모란), cranes, carp, ten longevity symbols. Unconventional compositions filling entire surface. Primitive folk art quality . Traditional Korean hanbok clothing if people present.`
  },
