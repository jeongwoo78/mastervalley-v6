...
export const MODERNISM_PROMPTS = {
  ...
  'magritte-golconda': {
    name: '골콩다',
    nameEn: 'Golconda',
    prompt: `Hand-painted oil painting of the subject by René Magritte. Smooth realistic brushwork renders every surface with photographic precision. Ordinary objects placed in impossible arrangements. Colors are muted and naturalistic with clear even lighting. Edges are clean and precise, surface entirely smooth throughout. Ordinary figures float in the sky in surreal calm. Dark grey 30%, pale blue 30%, beige 20%, crimson red 20%. Pale blue sky and red-roofed buildings fill the background. The subject wears a bowler hat and dark overcoat, repeated identically as dozens of figures floating in the sky in a grid pattern, growing smaller with distance. Face painted smooth and realistic, expression still and neutral. Soft light from the left brightens one side of the face. Smooth brushwork flows precisely along building lines and sky. Soft light illuminates figures and buildings from the left. Dark grey sinks into coats and right sides of figures. Blue fills the sky, grey fills coats, red fills rooftops, beige fills buildings.`
  },
