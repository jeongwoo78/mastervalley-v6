...
export const masterworkNameMapping = {
  ...
  // 모더니즘
  'golconda': 'magritte-golconda', '골콘다': 'magritte-golconda',
...
⚠️ For COUPLE: Bride of the Wind. Kokoschka style: Violent turbulent slashing brushwork, harsh acidic feverish colors, deeply distorted psychological tension.`,
  ...
  // ========================================
  'picasso': `
PABLO PICASSO - MASTERWORK:
"Portrait of Dora Maar" (도라 마르의 초상, 1937) → SINGLE PERSON portrait | Style: Cubist DOUBLE PROFILE showing FRONT and SIDE view simultaneously, VIBRANT COLORS red yellow green blue, sharp angular geometric face planes, seated pose, bold black outlines

⚠️ Picasso style: Cubist fragmentation, multiple viewpoints simultaneously, bold outlines, vibrant primary colors.`,

  'magritte': `
RENÉ MAGRITTE - MASTERWORK:
"Golconda" (골콘다, 1953) → GROUP, surreal, floating | Style: identical men in dark suits and bowler hats floating/raining against Belgian townhouse buildings, blue sky, repetition pattern

⚠️ Magritte style: Philosophical visual paradox, mysterious surreal scenarios, Belgian architecture, dreamlike impossible situations.`,
