...
// ========================================
// 🏛️ 오래된 명화 질감 (VINTAGE_TEXTURE) - v71에서 제거됨
// Old oil painting 접두어로 대체
// ========================================
// export const VINTAGE_TEXTURE = ' on aged canvas with visible woven texture, slightly muted vintage tones like museum masterpiece.';
export const VINTAGE_TEXTURE = ''; // v71: 비활성화

// 빈티지 질감 제외 스타일 (캔버스 아닌 매체) - v71: 더 이상 사용 안 함
